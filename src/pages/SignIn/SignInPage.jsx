                ...
                <div className=" regal- write w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-white dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-black">
                            Đăng nhập vào Duckies
                        </h1>
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                <label htmlFor="email" className="flex justify-start block mb-2 text-sm font-medium dark:text-black dark:text-black">Nhập email của bạn *</label>
                            ...
                            <div>
                                <label htmlFor="password" className="flex justify-start block mb-2 text-sm font-medium dark:text-black dark:text-black">Nhập mật khẩu *</label>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400 ">
                                Bạn chưa có sẵn tài khoản? <Link to="/register" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Đăng ký</Link>
                            </p>
                        </form>
                    </div>
                </div>
