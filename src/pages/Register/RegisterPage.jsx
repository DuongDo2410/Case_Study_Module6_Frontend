...
export function RegisterPage() {
    return (
        ...
        <section className="bg-gray-50 dark:bg-gray-900">
            <div className=" bg-[#ffffff] flex flex-col items-center justify-center  mx-auto md:h-screen lg:py-0">
                <div className=" regal- write w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-white dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                <label htmlFor="username" className="flex justify-start block mb-2 text-sm font-medium dark:text-black dark:text-black">Nhập tên đăng nhập *</label>
                                <input type="text" name="username" id="username" className=" bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the your name" required />
                            </div>
                            <div>
                            ...
                            <div>
                                <label htmlFor="phoneNumber" className="flex justify-start block mb-2 text-sm font-medium dark:text-black dark:text-black">Nhập Số Điện Thoại *</label>
                                <input type="number" name="email" id="number" className=" bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nhập số điện thoại" required />
                            </div>
                            <div>
                            ...
                            <div>
                                <label htmlFor="fullName" className=" flex justify-start block mb-2 text-sm font-medium text-gray-900 dark:text-black">Họ tên *</label>
                                <input type="text" name="fullName" id="fullName" placeholder="Nhập họ tên" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black " required />
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400 ">
                               Bạn có sẵn sàng tạo một tài khoản? <Link to={"/login"} className="font-medium text-primary-600 hover:underline dark:text-primary-500">Đăng nhập</Link>
                            </p>
                        </form>
                    </div>
                </div>
