        ...
        <dl className="mt-2 flex flex-wrap justify-start text-sm leading-6 font-medium">
          ...
          <div>
            ...
            <dd className="flex items-center">
              ...
              {props.history.idHome.amountBedroom} phòng ngủ,{" "}
              {props.history.idHome.amountBathroom} phòng tắm
            </dd>
          </div>
          <div className="flex-none w-full mt-2 font-normal flex flex-wrap justify-start">
            <dt className="sr-only">Cast</dt>
            <dd className="text-slate">{props.history.totalMoney} VND</dd>
          </div>
        </dl>
      </div>
    </article>
